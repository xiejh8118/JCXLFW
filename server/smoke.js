...
(async () => {
  ...
  out.ai = await req('POST', '/api/ai/chat', { messages: [{ role: 'user', content: '我们需要在西港租一套团队公寓' }], lang: 'zh-CN' });
  out.match = await req('POST', '/api/match', { type: 'accommodation', query: '西港 团队', lang: 'zh-CN' });
